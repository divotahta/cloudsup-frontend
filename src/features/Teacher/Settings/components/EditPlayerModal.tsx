...
export default function EditPlayerModal({ open, player, onClose, onSave }: EditPlayerModalProps) {
			...
			<div className="relative w-[900px] max-w-[90%] bg-white rounded-2xl border border-[#0066FF] shadow-[8px_8px_0_0_#084EC5] flex flex-col overflow-hidden opacity-100 transform scale-100 translate-y-0 transition-[opacity,transform] duration-200">
				...
				<div className="p-6 flex flex-col gap-6">
					<div className="flex flex-col gap-4 text-center px-6">
						<h3 className="font-['Raleway'] font-bold text-[24px] text-[#0066FF] leading-[31.92px] m-0">Edit Detail Pemain</h3>
						...
						<div className="grid grid-cols-1 sm:grid-cols-2 gap-4 grow">
							<div>
								<div className="flex flex-col gap-2 font-['Raleway']">
									...
									<div className="relative w-full h-14">
										<input defaultValue={firstName} title={player.name} type="text" placeholder="Masukkan nama depan" className="w-full h-full px-5 py-4 rounded-lg border border-[#BFBFBF] box-border font-medium text-[16px] text-[#262626] leading-[1.5em] outline-none transition-all duration-[400ms] ease-[cubic-bezier(0.34,1.56,0.64,1)] bg-white shadow-none" />
									</div>
								</div>
							...
							<div>
								<div className="flex flex-col gap-2 font-['Raleway']">
									...
									<div className="relative w-full h-14">
										<input defaultValue={lastName} type="text" placeholder="Masukkan nama belakang" className="w-full h-full px-5 py-4 rounded-lg border border-[#BFBFBF] box-border font-medium text-[16px] text-[#262626] leading-[1.5em] outline-none transition-all duration-[400ms] ease-[cubic-bezier(0.34,1.56,0.64,1)] bg-white shadow-none" />
									</div>
								</div>
								<p className="m-0 font-['Raleway'] font-normal text-[12px] text-[#E82D2F] tracking-[0.4px] leading-4 pl-1 opacity-0 max-h-0 overflow-hidden transition-[opacity,max-height,margin-top] duration-300 ease-[cubic-bezier(0.34,1.56,0.64,1)]"></p>
							</div>
							<div>
								<div className="flex flex-col gap-2 font-['Raleway']">
									...
									<div className="relative w-full h-14">
										<input defaultValue={player.absen} title={player.absen} type="text" placeholder="Contoh: 12" className="w-full h-full px-5 py-4 rounded-lg border border-[#BFBFBF] box-border font-medium text-[16px] text-[#262626] leading-[1.5em] outline-none transition-all duration-[400ms] ease-[cubic-bezier(0.34,1.56,0.64,1)] bg-white shadow-none" />
									</div>
								</div>
								<p className="m-0 font-['Raleway'] font-normal text-[12px] text-[#E82D2F] tracking-[0.4px] leading-4 pl-1 opacity-0 max-h-0 overflow-hidden transition-[opacity,max-height,margin-top] duration-300 ease-[cubic-bezier(0.34,1.56,0.64,1)]"></p>
							</div>
							<div className="min-w-0 w-full">
								<div className="flex flex-col gap-2 font-['Raleway'] relative">
									...
									<div className="relative w-full h-14">
										<div title={player.disability} className="w-full h-full pr-10 pl-5 py-4 rounded-lg border border-[#BFBFBF] box-border font-medium text-[16px] text-[#262626] leading-[1.5em] outline-none transition-all duration-[400ms] ease-[cubic-bezier(0.34,1.56,0.64,1)] cursor-pointer bg-white overflow-hidden text-ellipsis whitespace-nowrap">
											{player.disability}
										</div>
							...
							<div>
								<div className="flex flex-col gap-2 font-['Raleway']">
									...
									<div className="relative w-full h-14">
										<input defaultValue={player.email} title={player.email} type="text" placeholder="Contoh: email@gmail.com" className="w-full h-full px-5 py-4 rounded-lg border border-[#BFBFBF] box-border font-medium text-[16px] text-[#262626] leading-[1.5em] outline-none transition-all duration-[400ms] ease-[cubic-bezier(0.34,1.56,0.64,1)] bg-white shadow-none" />
									</div>
								</div>
								<p className="m-0 font-['Raleway'] font-normal text-[12px] text-[#E82D2F] tracking-[0.4px] leading-4 pl-1 opacity-0 max-h-0 overflow-hidden transition-[opacity,max-height,margin-top] duration-300 ease-[cubic-bezier(0.34,1.56,0.64,1)]"></p>
							</div>
					...
					<div className="flex gap-6 mt-4">
						...
						<button className="flex-1 p-4 rounded-lg border-0 font-['Raleway'] font-bold text-[14px] leading-4 cursor-pointer transition-[transform,opacity] duration-[450ms] ease-[cubic-bezier(0.34,2,0.64,1)] bg-[#0066FF] text-white scale-100 opacity-100">Simpan</button>
					</div>
				</div>
			</div>
