      ...
      series: [
        {
          ...
          data: [
            // Update data series
            { y: weekComparisonData.week1, color: "rgb(198, 25, 8)" },
            { y: weekComparisonData.week2, color: "rgb(198, 25, 8)" },
            { y: weekComparisonData.week3, color: "rgb(198, 25, 8)" },
            { y: weekComparisonData.week4, color: "rgb(198, 25, 8)" },
          ],
          pointPadding: 0.2,
          groupPadding: 0.3,
        },
            ...
            <div className="flex-1">
              ...
              <div className="mb-6">
                ...
                <div className="h-[9px] bg-white relative">
                  {/* Progress Fill */}
                  <div
                    className="absolute top-0 left-0 h-[9px] bg-[#084EC5]" // Warna progress bar (biru) mungkin perlu disesuaikan dengan tema oranye/merah jika diperlukan
                    style={{ width: "81.1%" }}
                  >
                    {/* Marker at 81.1 */}
                    <div className="absolute right-0 top-1/2 -translate-y-1/2 translate-x-1/2">
                      <div className="flex flex-col items-center">
                        ...
                        <div className="w-px bg-white mt-1" /> {/* Ubah warna garis marker menjadi putih agar kontras */}
                      </div>
                    </div>
                  </div>
                </div>
