    ...
    <div className="flex items-center justify-between">
      ...
      <div className="flex items-center gap-[28px]">
        ...
        <div className="flex flex-col gap-2">
          <p className="font-raleway font-normal text-sm text-[#262626]">
            Menampilkan Kemajuan Selama 30 Hari Terakhir
          </p>
          <div className="flex items-center gap-2">
            <button className="px-4 py-2 bg-white border border-[#BFBFBF] rounded-lg flex items-center gap-2 cursor-pointer hover:bg-gray-50">
              <Calendar className="w-5 h-5 text-gray-600" />
              <span className="font-raleway font-medium text-sm text-gray-700">07-Jul-2025 to 05-Aug-2025</span>
            </button>
            <button className="px-4 py-2 bg-[#084EC5] text-white rounded-lg font-raleway font-bold text-sm hover:bg-[#063CA3] transition-colors">
              Laporan Terbaru
            </button>
          </div>
        </div>
