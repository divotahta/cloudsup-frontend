  ...
  return (
    <div className="bg-white rounded-lg p-6">
      ...
      <div className="relative w-full h-[221px] rounded-lg overflow-hidden mb-6">
        {/* Background Image */}
        <img 
          src="https://framerusercontent.com/images/dlIs2ajmBZ1vND4JCYHKNCabFs.png?width=3648&height=884"
          alt="Reaction Time background"
        ...
        <div className="absolute inset-0 flex flex-col justify-between p-6">
          ...
          <div className="mt-4">
            <p className="font-raleway font-semibold text-[15px] leading-[18px] text-white">
              Kemampuan untuk mendeteksi dan merespons rangsangan/isyarat yang disajikan di lingkungan permainan secara cepat, memastikan reaksi yang tepat waktu dan efisien terhadap berbagai tantangan.
            </p>
          </div>
        </div>

        {/* Chart SVG Overlay */}
        <div className="absolute top-4 right-4 w-[433px] h-[171px] opacity-80">
          <div className="w-full h-full">
            <div className="w-full h-full" style={{ aspectRatio: 'inherit' }}>
              <img 
                src="https://framerusercontent.com/images/LyjPRBlWzmzXE9CSd1Q6z8O3Nw.svg?width=433&height=171"
                alt="Chart"
