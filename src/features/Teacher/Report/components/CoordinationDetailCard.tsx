      ...
      series: [
        {
          ...
          data: [
            // Update data series
            { y: weekComparisonData.week1, color: "rgb(210, 33, 21)" },
            { y: weekComparisonData.week2, color: "rgb(210, 33, 21)" },
            { y: weekComparisonData.week3, color: "rgb(210, 33, 21)" },
            { y: weekComparisonData.week4, color: "rgb(210, 33, 21)" },
          ],
          pointPadding: 0.2,
          groupPadding: 0.3,
        },
    ...
    <button
      ...
      className={`px-4 py-2 rounded-none bg-transparent font-['Raleway'] font-bold text-[14px] leading-[21px] transition-colors ${
        activeWeek === week
          ...
          : "text-[#C21315] hover:bg-red-50" // Ubah hover color agar sesuai tema merah
      }`}
      style={{
              ...
              <div className="">
                ...
                <div className="">
                  ...
                  <div className="h-[9px] bg-white relative">
                    {/* Progress Fill */}
                    <div
                      className="absolute top-0 left-0 h-[9px] bg-[#084EC5]" // Tetap gunakan warna biru untuk progress fill? (Menggunakan warna yang berbeda dari tema merah)
                      style={{ width: "81.1%" }}
                    >
                      {/* Marker at 81.1 */}
